...
| Vela `v0.930.0-rc.4` | attested prerelease artifacts and one low-risk active Frontier | installable candidate, key-free preview, single-new-writer proof, and recovery exercise |
