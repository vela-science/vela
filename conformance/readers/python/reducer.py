...
#
# Usage:
#   python3 conformance/readers/python/reducer.py /path/to/cascade-fixture-00.json
#   python3 conformance/readers/python/reducer.py /path/to/fixtures/dir/
#   python3 conformance/readers/python/reducer.py --json /path/to/fixture.json
#
# Exit codes:
