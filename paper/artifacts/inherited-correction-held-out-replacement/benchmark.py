...
def assignment_plan() -> dict[str, Any]:
    ...
    for index, cell in enumerate(cells, 1):
        assignments.append(
            {
                **cell,
                "run_id": f"schemafix-run-{index:02d}",
                "participant_instance_id": f"schemafix-sol-{index:02d}",
            }
        )
    return {
...
def generated_outputs() -> dict[str, bytes]:
    ...
    calibration_plan = {
        ...
        "run_id": "neutral-schemafix-calibration-01",
        "participant_instance_id": "neutral-schemafix-sol-01",
    ...
    outputs[
        "calibration/permit-template/neutral-schemafix-calibration-01.permit.json"
    ...
    freeze = {
        ...
        "permit_set_root": canonical_root(
            [
                ...
                if path.startswith("permit-template/schemafix-run-")
            ]
        ),
