...
> Current disposition: this decision is fully retired. Current repositories
> carry neither AcceptancePolicy nor Permit, and Submission v3 removed the
> execution-binding object and field. Source-owned execution evidence crosses
> the boundary through ordinary Artifact, Method, and provenance references.
> The historical body below describes the old experiment only.
