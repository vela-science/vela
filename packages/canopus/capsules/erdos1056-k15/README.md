...
`10429601..10429800`. It accepts one byte-exact artifact describing
...
```bash
mkdir -p capsules/erdos1056-k15/bin/linux-arm64/10429601-10429800
aarch64-linux-gnu-g++ -O3 -std=c++20 -static -s \
  -DCANOPUS_RANGE_START=10429601 -DCANOPUS_RANGE_END=10429800 \
  capsules/erdos1056-k15/verifier.cpp \
  -o capsules/erdos1056-k15/bin/linux-arm64/10429601-10429800/verifier
```

The active Linux ARM64 capsule SHA-256 root is
`ace7a3054d77af31391b3103ab397d5dac8fd5fd6a62211fde6c6bf5863e59f7`.
...
`f91eeee3e113682fca263de0b1cfad623284bebe24cecb167426c8ad300ef767`.
