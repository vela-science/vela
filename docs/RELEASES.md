...
- **Vela 0.975.1** is the current signed pre-1.0 implementation release.
- **Vela 0.976.0** is the qualified candidate that adds the stable,
  ...
  crate machinery. Tagging, signing, and publication remain separate gates.
