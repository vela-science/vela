...
fn print_session_help() {
    ...
    println!();
    println!("  DAILY FLOW");
    println!("    init              Initialize a .vela frontier repo");
    println!("    status            One-screen frontier health");
    println!("    log               Recent state events");
    println!("    inbox             Pending review proposals");
    println!("    review            Review a proposal");
    ...
    println!();
    println!("  COMPOSITION");
    println!("    bridges derive <a> <b>             Cross-frontier hypotheses");
