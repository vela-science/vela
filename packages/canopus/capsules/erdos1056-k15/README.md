...
`10429401..10429600`. It accepts one byte-exact artifact describing
...
```bash
mkdir -p capsules/erdos1056-k15/bin/linux-arm64/10429401-10429600
aarch64-linux-gnu-g++ -O3 -std=c++20 -static -s \
  -DCANOPUS_RANGE_START=10429401 -DCANOPUS_RANGE_END=10429600 \
  capsules/erdos1056-k15/verifier.cpp \
  -o capsules/erdos1056-k15/bin/linux-arm64/10429401-10429600/verifier
```

The active Linux ARM64 capsule SHA-256 root is
`70baf5baaa44a5a955aea189b0c1393dca11d0731ca32537366460c697e5a255`.
...
`68f64c3dc4bc55e98927f65ba509e5c571944239337864bbf631546ac259cdf4`.
