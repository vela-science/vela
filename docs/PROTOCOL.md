...
- **v0.760.1**: new task-first landing results report the canonical accepted
  ...
  A journal-free retry recovered only from older public state reports null
  historical counts instead of fabricating a prior frontier head.
