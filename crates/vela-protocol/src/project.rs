...
pub const VELA_SCHEMA_URL: &str = "https://vela.science/schema/finding-bundle/v0.7.0";
pub const VELA_SCHEMA_VERSION: &str = "0.7.0";
pub const VELA_COMPILER_VERSION: &str = "vela/0.7.0";
