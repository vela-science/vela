...
| --- | --- | --- | --- |
| VRC1-F001 | `QUALIFICATION GAP` | Hosted conformance is green for an ancestor, not exact RC-1 baseline `421cdc0d...` | Run exact local union; hosted qualification belongs to any later authorized release process |
