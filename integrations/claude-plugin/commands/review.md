...
- **Keep objects distinct.** A proposal, retained Receipt, verifier evidence,
...
4. For the selected proposal, report:
   ...
   - Receipt and artifact availability;
   - verifier attachments and their exact scoped outcomes;
