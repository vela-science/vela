...
function usage(message) {
  ...
  process.stderr.write(
    "Usage:\n" +
      "  node clients/javascript/vela_emit.mjs submission --draft <json> --seed-file <path> --output <json>\n" +
      "  node clients/javascript/vela_emit.mjs verification --draft <json> --seed-file <path> --output <json>\n",
  );
